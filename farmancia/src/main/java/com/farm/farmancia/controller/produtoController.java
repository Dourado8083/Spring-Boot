...
import com.farm.farmancia.Repository.produtoRepository;
...
private produtoRepository ProdutoRepository;
	...
	public ResponseEntity<List<Produto>> getByfornecedor(@PathVariable String forne){
		return ResponseEntity.ok(ProdutoRepository.findAllByfornecedorContainingIgnoreCase(forne));
	}	
